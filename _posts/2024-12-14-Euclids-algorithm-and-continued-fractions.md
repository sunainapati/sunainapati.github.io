...
$$ | \alpha - \frac{a_1}{q_1}| < \frac{1}{q_1Q_1} \leq \frac{1}{q_1^2}.$$ 
If $\frac{a_1}{q_1} = \alpha$, then $\alpha$ is rational, then we are done.
If not, then $ | \alpha - \frac{a_1}{q_1}| > 0$, then we can take a new $Q_2$ large enough such that $ \left| \alpha - \frac{a_1}{q_1}\right| > \frac{1}{Q_2}.$ Let $\frac{a_2}{q_2}$ be the pair guaranteed by Theorem for $Q_2$. Then 
$$ | \alpha - \frac{a_2}{q_2}| < \frac{1}{q_2Q_2} < \frac{| \alpha - \frac{a_1}{q_1}|}{q_2} \leq | \alpha - \frac{a_1}{q_1}|,$$ 
so $\frac{a_2}{q_2}$ is distinct from $\frac{a_1}{ q_1}$. Furthermore,
$$ | \alpha - \frac{a_2}{q_2}| < \frac{1}{q_2Q_2} \leq \frac{1}{q_2^2}.$$
</div>
...
does not change sign.
 ...
 $$| \frac{r}{s} - \frac{p_n}{q_n}| \geq \frac{1}{s q_n},$$
 because $\frac{r}{s} \neq \frac{p_n}{q_n}$, and similarly 
 $$| \frac{r}{s} - L| \geq \frac{1}{s (t q_n + q_{n-1})}.$$
