...
Otherwise, if $r \in B_t(x) \cap B_t(y)$, then both

$$
d(x, r) \leq t \quad \text{and} \quad d(y, r) \leq t,
$$

so $r$ could be decoded ambiguously.
